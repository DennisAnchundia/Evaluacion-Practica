...
class Backend {
  ...
  final _Smartphones = [
    Smartphone(
      id: 631,
      color: 'Rojo',
      modelo: 'Smartphone programming',
      precio: DateTime(2020, 10, 03, 19, 43),
      descripcion:
    ...
    Smartphone(
      ...
      color: 'Rojo',
      modelo: 'Smartphone programming',
      precio: DateTime(2020, 10, 07, 03, 05),
      descripcion:
    ...
    Smartphone(
      ...
      color: 'Rojo',
      modelo: 'Smartphone programming',
      precio: DateTime(2020, 10, 09, 13, 48),
      descripcion:
    ...
    Smartphone(
      ...
      read: true,
      color: 'Rojo',
      modelo: 'Smartphone code',
      precio: DateTime(2020, 10, 11, 16, 14),
      descripcion:
    ...
    Smartphone(
      id: 835,
      color: 'Rojo',
      modelo: 'Smartphone programming language',
      precio: DateTime(2020, 10, 13, 20, 25),
      descripcion:
    ...
    Smartphone(
      id: 966,
      color: 'Verde',
      modelo: 'Smartphone scope',
      precio: DateTime(2020, 10, 14, 23, 59),
      descripcion:
    ...
    Smartphone(
      id: 237,
      color: 'Verde',
      modelo: 'Smartphone function',
      precio: DateTime(2020, 10, 16, 21, 09),
      descripcion:
    ...
    Smartphone(
      ...
      color: 'Verde',
      modelo: 'Smartphone programming language',
      precio: DateTime(2020, 10, 18, 18, 10),
      descripcion:
    ...
    Smartphone(
      id: 759,
      color: 'Azul',
      modelo: 'Smartphone Lisp',
      precio: DateTime(2020, 10, 22, 21, 21),
      descripcion:
    ...
    Smartphone(
      ...
      color: 'Azul',
      modelo: 'Smartphone programming',
      precio: DateTime(2020, 10, 26, 08, 54),
      descripcion:
